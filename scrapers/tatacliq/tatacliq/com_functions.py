...
def csv_writer(fh, id, name, permalink, create_date, mrp,price,offer_price,discount,store_id,category,category_id,\
    ...
    line = '"%s","%s","%s","%s","%s","%s","%s","%s","%s","%s","%s","%s","%s","%s","%s","%s","%s","%s","%s","%s",\
           ...
           mrp,price,offer_price,discount,store_id,category,category_id, data_source,ref_id,url,image_url,\
           description,deal_notes,meta_title,meta_key,meta_des,brand, size,size_unit,color,key_features,features,\
